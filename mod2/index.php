...
$LANG->includeLLFile('EXT:mtss/mod2/locallang.xml');
require_once(PATH_t3lib . 'class.t3lib_scbase.php');
$BE_USER->modAccess($MCONF,1);	// This checks permissions and exits if the users has no permission for entry.
	// DEFAULT initialization of a module [END]
require_once(t3lib_extMgm::extPath("mtss").'/func/FCE_show.php');

$SHOW = new tx_mtss_FCE_show;
$IS_PATH='/var/www/mss/';
$IMG_PATH='/mss/';
				...
				function moduleContent()	{
					...
					switch((string)$this->MOD_SETTINGS['function'])	{
						...
						case 2:
							...
							else $content.=$SHOW->informacja(array($LANG->getLL('informacja_brak_pliku_szablonu'),$LANG->getLL('informacja_brak_pliku_szablonu_zelecenie_1')));
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mtss/mod2/index.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mtss/mod2/index.php']);
}
